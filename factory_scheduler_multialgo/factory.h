...
/* ── Gantt chart capacity and marker values ─────────────────
   Normal PID values are >= 0.
   GANTT_CONTEXT_SWITCH is a special marker used to display scheduler
   switching overhead directly in the final Gantt chart. */
#define GANTT_MAX 4000
#define GANTT_CONTEXT_SWITCH -2
...
extern int          g_timeSlice;      /* dynamic base quantum */
extern int          g_agingLimit;     /* dynamic aging threshold */
...
extern int g_ganttPid  [GANTT_MAX];   /* pid processed, or CS marker    */
...
/* Dynamic scheduling policy helpers exposed for reporting/GUI parity. */
